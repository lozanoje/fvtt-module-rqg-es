...
//
// Note: requires about-time and simple-calendar to work
...
// Pause Foundry and Paste this line into the console:

game.Gametime.setTime({ hours: 0, minutes: 0, seconds: 0 });

// The time should now be 00:00:00
// Copy everything else below here and paste it into the console. 

Gametime.doEvery({ days: 1 }, () => {
  dateToChatSeasons();
